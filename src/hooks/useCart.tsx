...
export function CartProvider({ children }: CartProviderProps): JSX.Element {
  ...
  const addProduct = async (productId: number) => {
    try {
      ...
      const productExists = updateProduct.find(product => product.id === productId)
  ...
  const removeProduct = (productId: number) => {
    try {
     ...
     const productIndex = updatedProduct.findIndex(removeProduct => removeProduct.id === productId)
